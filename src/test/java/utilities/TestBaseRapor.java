...
public abstract class TestBaseRapor {
    public static  String userStoryNumber="03";
    ...
    public void setUpTest() {
        ...
        String filePath = System.getProperty("user.dir") + "/reportsandimages/reports/US_"+userStoryNumber+"_reports/US_"+userStoryNumber+"_" +date+".html";
        ...
        extentReports.setSystemInfo("Automation Engineer", ConfigReader.getProperty("13"));
    ...
    public void tearDownMethod(ITestResult result) throws IOException {
        if (result.getStatus() == ITestResult.FAILURE) { // eğer testin sonucu başarısızsa
            String screenshotLocation = ReusableMethods.getScreenshot(userStoryNumber,result.getName());
